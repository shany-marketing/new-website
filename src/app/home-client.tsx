...
const PARTNERS = [
  ...
  { name: "Israel Canada", logo: "/partners/israel-canada.png", maxWidth: "240px" },
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--page-gradient)" }}>
          ...
          <div className="max-w-6xl mx-auto h-20 grid grid-cols-[1fr_auto_1fr] items-center">
            ...
            <div className="flex items-center justify-end gap-3">
              <div className="hidden md:flex items-center gap-3">
                ...
                <Link href="/signup" className="text-sm font-semibold transition-colors duration-200 px-4 py-2" style={{ color: "var(--foreground)" }}>Sign Up</Link>
                <button
        ...
        {mobileNav && (
          <div className="md:hidden border-t px-4 pb-4 pt-2" style={{ background: "var(--nav-scrolled-bg)", backdropFilter: "blur(12px)", borderColor: "var(--glass-border)", boxShadow: "0 15px 40px rgba(0,0,0,0.2)" }}>
            ...
            <div className="flex flex-col gap-2 mt-3 pt-3 border-t" style={{ borderColor: "var(--glass-border)" }}>
              ...
              <Link href="/login" onClick={closeMobileNav} className="font-semibold transition-colors py-2" style={{ color: "var(--foreground)" }}>Log In</Link>
              <Link href="/signup" onClick={closeMobileNav} className="font-semibold transition-colors py-2" style={{ color: "var(--foreground)" }}>Sign Up</Link>
              <button
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        <a
          href="https://www.linkedin.com/company/ratingiq/"
          target="_blank"
          ...
          aria-label="RatingIQ on LinkedIn"
        >

  ...
  const html = `
    <div style="font-family: Inter, Arial, sans-serif; max-width: 520px; padding: 32px; background: #f9f8f6; border-radius: 8px;">
      <div style="margin-bottom: 24px;">
        <span style="font-size: 13px; font-weight: 600; color: #C9A86A; text-transform: uppercase; letter-spacing: 0.08em;">RatingIQ — New Website Lead</span>
      </div>
      <h2 style="margin: 0 0 8px; font-size: 22px; color: #1C2A39; font-weight: 700;">New lead from the homepage.</h2>
      <p style="margin: 0 0 24px; font-size: 15px; color: #516B84;">Someone filled out a form on rating-iq.com.</p>
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding: 10px 0; border-bottom: 1px solid #e0dbd4; font-size: 13px; color: #516B84; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Email</td>
          <td style="padding: 10px 0; border-bottom: 1px solid #e0dbd4; font-size: 15px; color: #1C2A39; font-weight: 600;"><a href="mailto:${email}" style="color: #1C2A39; text-decoration: none;">${email}</a></td>
        </tr>
        ${hotel ? `
        <tr>
        ...
        <tr>
          ...
          <td style="padding: 10px 0; border-bottom: 1px solid #e0dbd4; font-size: 14px; color: #516B84;">${ctaSource || "—"}</td>
        </tr>
        <tr>

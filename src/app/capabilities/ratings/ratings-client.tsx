        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1 } } }} className="mb-10">
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }} className="flex flex-wrap gap-3">
              ...
              <Link href="/premium" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm transition-all hover:text-foreground" style={{ ...glass, color: "var(--muted)" }}>
                Drive Your Revenue →
              </Link>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ duration: 0.5 }} className="mt-16 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link href="/premium" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl font-semibold transition-all hover:text-foreground" style={{ ...glass, color: "var(--muted)" }}>
                Explore Premium →
              </Link>
            </div>
          </motion.div>
